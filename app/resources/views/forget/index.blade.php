    ...
    <div class="container-fluid user-auth">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-8">
            ...
            <a class="visible-xs" href="{{ url('') }}">
                <img id="logo" class="img-responsive mobile-logo" src="{{ url('resources/upload/logos/'.$image_setting['logo']) }}" alt="logo">
            </a>
            <!-- Logo Ends -->
            ...
            <div class="form-container">
                <div>
                    ...
                    <div class="row text-center">
                        <h2 class="title-head hidden-xs">بازیابی <span>رمز عبور</span></h2>
                        <p class="info-form">بازیابی رمز عبور شخصی</p>
                    </div>

                    {!! Form::open(['url'=>'forget-password']) !!}

                    @if(\Illuminate\Support\Facades\Session::has('errors'))
                        <div class="alert alert-danger" role="alert">
                            شماره همراه مورد نظر در سیستم وجود ندارد
                        </div>
                    @endif
                    ...
                    <div class="form-group">
                        <input class="form-control" name="username" id="username" placeholder="شماره همراه" type="text" required>
                        @if($errors->has('username'))   <div class="error">{{ $errors->first('username') }}</div> @endif
                    </div>


                    <div class="form-group">
                        <button class="btn btn-primary" type="submit">بازیابی رمز عبور</button>
                        <p class="text-center">ورود به حساب کاربری؟ <a href="{{ url('login') }}">ورود</a>
                    </div>
