                ...
                <div class="form-container">
                    <div>
                        ...
                        <div class="row text-center">
                            <h2 class="title-head hidden-xs">ورود <span>حساب کاربری</span></h2>
                            <p class="info-form">ورود به حساب کاربری شخصی</p>
                        </div>

                        {!! Form::open(['url'=>'login']) !!}
                        @if(\Illuminate\Support\Facades\Session::has('send'))
                            <div class="alert alert-success" role="alert">
                                رمز عبور موقت به شماره همراه شما ارسال گردید
                            </div>
                        @endif
                        ...
                        <div class="form-group">
                            <button class="btn btn-primary" type="submit">ورود حساب کاربری</button>
                            <p class="text-center">فراموشی رمز عبور؟ <a href="{{ url('forget-password') }}">بازیابی رمز عبور</a>
                        </div>
