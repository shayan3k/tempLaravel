        ...
        <div>
            <div class="text-center">
                ...
                <a class="logo" href="{{ url('') }}">
                    <img id="logo" class="img-responsive" src="{{ url('resources/upload/logos/'.$image_setting['logo']) }}" alt="{{ $single_setting['title'] }}">
                </a>
                <!-- Logo Ends -->
                ...
                <a href="{{ url('') }}" class="btn btn-primary">صفحه نخست</a>
                <!-- Error 404 Content Starts -->
            </div>
        </div>
    </div>
