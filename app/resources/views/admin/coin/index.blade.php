...
<div class="span12">
							...
							<div class="portlet box green">
								<div class="portlet-title">
									<div class="caption"><i class="fa fa-servicepaper-o"></i>مدیریت ارز ها</div>

									<div class="actions">

									@can('add-coin')	<a href="{{ url('adm-panel/coin/create') }}" class="btn purple"><i class="fa fa-plus"></i> افزودن ارز جدید </a> @endcan
									</div>
								...
								<div class="portlet-body flip-scroll">
										...
										<tbody>
										        @foreach($coin as $key=>$value)
														...
														<td><a href="{{ url('adm-panel/coin/'.$value->id.'/edit') }}" target="_blank">{{ $value->title }}</a></td>


                                                                <td>
                                                                    @can('edit-coin')
														<a href="{{ url('adm-panel/coin/'.$value->id.'/edit') }}" class="btn mini purple size-13"><i class="fa fa-edit"></i> ویرایش </a>
                                                                    @endcan
                                                                        @can('delete-coin')
                                ...
                                <div class="modal-header">
                                    ...
                                    <h3 id="myModalLabel3" class="size-20">حذف ارز</h3>
                                </div>
                                <div class="modal-body">
                                    <p> آیا مایل به حذف ارز مورد نظر خود هستید؟ </p>
                                </div>
                                <div class="modal-footer">
                                <form method="post" action="{{ url('adm-panel/coin/'.$value->id) }}" id="form">
 ...
 @if(isset($page))
                    ...
                    {{ $coin->appends(request()->query())->links() }}
                            </div>
                            @endif
								</div>
							</div>
