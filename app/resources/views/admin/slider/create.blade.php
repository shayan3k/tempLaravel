...
<div class="row-fluid">
            <div class="span12">
                ...
                <ul class="breadcrumb">
                    ...
                    <li><a href="{{ url('adm-panel/slider/create') }}">ثبت اسلایدر</a></li>
...
<div class="container-fluid">
     ...
     {!! Form::open(['url'=>'adm-panel/slider','files'=>true]) !!}
...
<div class="row-fluid">
    ...
    <div class="form-group">
        <input type="text" id="title" class="form-control m-wrap span12" value="{{ old('title') }}" name="title" autocomplete="off">
    </div>
...
<div class="row-fluid">
	<div class="control-group">
            ...
            <div class="controls">
                <textarea class="span12 ckeditor m-wrap rtl size-13" id="editor" name="desc">{{ old('desc') }}</textarea>
            </div>
        </div>
</div>
