...
<div class="row-fluid">
            <div class="span12">
                ...
                <ul class="breadcrumb">
                    ...
                    <li>
                        <a href="{{ url('adm-panel/pages') }}">مدیریت برگه ها</a>
        ...
        <div class="span12">
                        <div class="portlet box purple">
                            ...
                            <div class="portlet-title">
                                <div class="caption"><i class="fa fa-file"></i> مدیریت برگه ها</div>
                                <div class="actions">
                                    @can('add-menu')
                                <a href="{{ url('adm-panel/pages/create') }}" class="btn green"><i class="fa fa-plus"></i> افزودن برگه جدید </a>
                                    @endcan
                                </div>
                            </div>
                            ...
                            <div class="portlet-body">
                                ...
                                <table class="table table-striped table-bordered table-hover table-full-width dataTable" id="My_Advanced_table" aria-describedby="My_Advanced_table_info">
                                    <thead>
                                        ...
                                        <th class="sorting" role="columnheader" tabindex="0" aria-controls="My_Advanced_table" rowspan="1" colspan="1" aria-label="نام برگه: مرتب کردن صعودی ستون ها " style="width: 337px;">نام برگه</th>
                                        <th class="sorting" role="columnheader" tabindex="0" aria-controls="My_Advanced_table" rowspan="1" colspan="1" aria-label="برگه: مرتب کردن صعودی ستون ها " style="width: 109px;">تاریخ ایجاد</th>
                                ...
                                <tr class="odd">
                                            ...
                                            <td class=" ">{{ $value->title }}</td>
                                             <td class=" ">{{ $jdf->jdate("Y/n/j",$value->date) }}</td>
                                            <td class=" ">
                                                @can('edit-menu')
                                                 <a href="{{ url('adm-panel/pages/'.$value->id.'/edit') }}" class="btn mini purple size-13"><i class="fa fa-edit"></i> ویرایش </a>
                                                @endcan
                                                    @can('delete-menu')
                                            ...
                                            <div id="delModal_<?=$value->id?>" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel3" aria-hidden="true">
                                                                            <div class="modal-header">
                                                                                ...
                                                                                <h3 id="myModalLabel3" class="size-20">حذف برگه</h3>
                                                                            </div>
                                                                            <div class="modal-body">
                                                                                <p> آیا مایل به حذف برگه مورد نظر خود هستید؟ </p>
                                                                            </div>
                                                                            <div class="modal-footer">
                                                                            <form method="post" action="{{ url('adm-panel/remove/pages') }}" id="form">
                                                                                                        <input type="hidden" name="_method" value="DELETE" >
                                                                                                        {{ csrf_field() }}
                                                                                                        <input type="hidden" value="{{ $value->id }}" name="page_id">
