...
<div class="container-fluid">
				...
				{!! Form::open(['url'=>'adm-panel/news','files'=>true]) !!}
						<div class="row-fluid">
                            ...
                            <div class="row-fluid">
                                <label for="title">عنوان خبر <span class="required ltr"> * </span></label>
                                <div class="form-group">
                                    <input type="text" autocomplete="off" class="form-control m-wrap span12" name="title"  value="{{ old('title') }}">
                                </div>
                               @if($errors->has('title')) <div class="help-block error">{{ $errors->first('title')}}</div> @endif
                            </div>

                                <div class="row-fluid next-line">

                                    <div class="span12">
                                        <label for="frm_description">توضیحات</label>
                                        <div class="form-group">
                                            <textarea class="form-control ext-area-full ckeditor" name="desc" id="editor">{{ old('desc') }}</textarea>
                                        </div>
                                ...
                                <div class="row-fluid next-line">
                                    <div class="span12">
                                        <label for="frm_keywords">برچسب ها</label>
                                        <div class="form-group">
                                            <input type="text" name="keywords" id="frm_keywords" data-role="tagsinput" value="{{ old('keywords') }}" placeholder="برچسب را وارد کرده و ENTER را بفشارید">
                                        </div>
                                        <p class="help-block"></p>
                                    </div>
                                </div>
                                ...
                                <div class="portlet box light">
                                    <div class="portlet-body form">
                                        ...
                                        <div class="row-fluid">
                                            ...
                                            <div class="d_i">
                                                <label for="icon">انتخاب تصویر خبر</label>
                                            </div>
                                            ...
                                            <div style="text-align: center;padding-top: 10px" class="help-block">لطفا یک تصویر مناسب برای خبر مورد نظر انتخاب فرمایید.</div>
                                            <br>
						...
						<div class="form-actions" id="add_etate_submit">
						    <button type="submit" class="btn green" > <i class="fa fa-check"></i> ثبت خبر </button>
						</div>
				{{ Form::close() }}
