...
<div class="container-fluid">
				  ...
				  {!! Form::model($row,['method'=>'PUT','files'=>true,'url'=>['adm-panel/news',$row['id']]]) !!}
						<div class="row-fluid">
...
<div class="row-fluid next-line">
    ...
    <div class="span12">
        ...
        <div class="form-group">
            <textarea class="form-control ext-area-full ckeditor"  name="desc" id="editor">{{ $row['desc'] }}</textarea>
        </div>
...
<div class="row-fluid next-line">
    <div class="span12">
        ...
        <div class="form-group">
            <input type="text" name="keywords"  value="{{ $row['keywords'] }}" id="frm_keywords" data-role="tagsinput" value="" placeholder="برچسب را وارد کرده و ENTER را بفشارید">
        </div>
        <p class="help-block"></p>
    </div>
</div>									</div>
                                    ...
                                    <div class="portlet-body form">
                                        ...
                                        <div class="row-fluid">
                                            ...
                                            <div class="form-group  @if($row->img!=null) next-line @endif">
                                                ...
                                                <img style="margin: 0 auto;display: block;cursor: pointer;" src="{{ url('resources/upload/news/'.$row['img']) }}" id="out_img" onclick="select_file()" />
                                            </div>
						...
						<div class="form-actions" id="add_etate_submit">
						    <button type="submit" class="btn green" > <i class="fa fa-check"></i>ویرایش خبر</button>
						</div>
				{{ Form::close() }}
