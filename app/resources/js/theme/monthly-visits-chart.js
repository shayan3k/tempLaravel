...
var monthlyPageviews = monthlyPageViewsChartData;
var monthlyVisitors = monthlyVisitorsChartData;
var monthName = monthlyVisitorsChartMonthName;
...
$("#monthly-chart").bind("plothover", function (event, pos, item) {
    ...
    if (item) {
        if (previousPoint != item.dataIndex) {
            ...
            showTooltip(item.pageX, item.pageY, item.series.label + " در روز " + x + monthName + " = " + y + " نفر ");
        }
    } else {
        $("#tooltip").remove();
        previousPoint = null;
