...
( function() {
	...
	function setUrl( fileUrl, data ) {
		...
		// The "data" argument may be used to pass the errors message to the editor.
 ...
 *
 * Read more in the [documentation](#!/guide/dev_file_manager_configuration-section3-adding-file-manager-scripts-for-selected-dialog-windows)
 * and see the [SDK sample](https://sdk.ckeditor.com/samples/fileupload.html).
 *
 ...
 *
 * Read more in the [documentation](#!/guide/dev_file_manager_configuration-section3-file-manager-window-size)
 * and see the [SDK sample](https://sdk.ckeditor.com/samples/fileupload.html).
 *
